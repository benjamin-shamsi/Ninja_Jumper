...
platforms = [floor,platform1,platform2,platform3,platform4,platform5,platform6,platform7,platform8,platform9, platform61, platform62]
plat61left = True
plat62left = False
#Gems
...
def draw():
    ...
    screen.draw.filled_rect(floor,groundcolour)
    ...
    screen.draw.text(str(points), center = (40,570), fontsize = 40, shadow = (1,1), color = (255,255,255), scolor = '#202020')
